...
CREATE TABLE `tb_content_personal`  (
  ...
  `create_datetime` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_bin COMMENT = '个人间不同应用的聊天记录、购物记录' ROW_FORMAT = Dynamic;

CREATE TABLE `tb_delivery`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `from_user_id` int NOT NULL,
  `to_user_id` int NOT NULL,
  `from_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `to_address` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
  `record_datetime` datetime NULL,
  `create_datetime` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_bin COMMENT = '个人间快递信息' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_info_user`  (
  ...
  `arrested` int NULL COMMENT '是否被抓捕',
  `score` float NULL COMMENT '分数',
  `create_datetime` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_bin ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `tb_search`  (
  ...
  `create_datetime` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_bin COMMENT = '搜索记录' ROW_FORMAT = Dynamic;
...
ALTER TABLE `tb_delivery` ADD CONSTRAINT `fk_tb_delivery_tb_info_user_1` FOREIGN KEY (`from_user_id`) REFERENCES `tb_info_user` (`id`);
ALTER TABLE `tb_delivery` ADD CONSTRAINT `fk_tb_delivery_tb_info_user_2` FOREIGN KEY (`to_user_id`) REFERENCES `tb_info_user` (`id`);
...
ALTER TABLE `tb_search` ADD CONSTRAINT `fk_tb_search_tb_info_app_user_1` FOREIGN KEY (`app_user_id`) REFERENCES `tb_info_app_user` (`id`);
